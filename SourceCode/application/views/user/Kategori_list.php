			...
			<div class="agileinfo_new_products_grids">
				...
				<div class="col-md-3 agileinfo_new_products_grid">
					<div class="agile_ecommerce_tab_left agileinfo_new_products_grid1">
						...
						<h5><a href="<?php echo site_url('Hardware/detail/'.$value->id_hardware)?>"><?php echo $value->merk_hardware; ?> <?php echo $value->tipe_hardware; ?></a></h5>
						<div class="simpleCart_shelfItem">
							...
							<form action="<?php echo site_url('Hardware/detail/'.$value->id_hardware)?>" method="post">  
